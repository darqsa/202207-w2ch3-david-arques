function pasapalabra () {
    ...
    let questions = [
            ...
            [
                ...
                {letter: "d", answer: "DIERESIS", question: "CON LA D. Signo ortográfico que se coloca encima de la u para indicar que esta letra ha de pronunciarse." }
            ],
            [
                ...
                {letter: "e", answer: "ESTRIA", question: "CON LA E. Línea que se forma en la piel cuando ésta se ha estirado excesivamente." }
            ],
            [
                {letter: "f", answer: "FACIL", question: "CON LA F. Que no requiere gran esfuerzo, capacidad o dificultad."},
                {letter: "f", answer: "FISIOLOGIA", question: "CON LA F. Ciencia que estudia las funciones de los órganos de los seres vivos." }
            ],
            [
                {letter: "g", answer: "GALAXIA", question: "CON LA G. Conjunto enorme de estrellas, polvo interestelar, gases y partículas."},
                {letter: "g", answer: "GUITARRA", question: "CON LA G. Instrumento musical con seis cuerdas que hacemos sonar con los dedos." }
            ],
            [
            ...
            [
                {letter: "i", answer: "IGLESOA", question: "CON LA I. Templo cristiano."},
            ...
            [
                ...
                {letter: "j", answer: "JABON", question: "CON LA J. Se utiliza para limpiar el cuerpo." }
            ],
            [
            ...
            [
                ...
                {letter: "l", answer: "LIBRERIA", question: "CON LA L. Lugar en el que se compran libros." }
            ],
            [
                ...
                {letter: "m", answer: "COMBA", question: "CONTIENE LA M. Juego que consiste en saltar por encima de una cuerda que se hace pasar por debajo de los pies y sobre la cabeza de quien salta." }
            ],
            [
                {letter: "n", answer: "NECEDAD", question: "CON LA N. Demostración de poca inteligencia."},
                {letter: "n", answer: "NARANJA", question: "CON LA N. Del campo semántico de los colores y el color de una fruta con la que podemos hacer zumo." }
            ],
            [
            ...
            [
                ...
                {letter: "o", answer: "OSCURO", question: "CON LA O. El antónimo de claro es..." }
            ],
            [
            ...
            [
                ...
                {letter: "q", answer: "EQUILATERO", question: "CONTIENE LA Q. Triángulo que tiene todos sus lados iguales." }
            ],
            [
            ...
            [
                ...
                {letter: "w", answer: "WATERPOLO", question: "CON LA W. Juego practicado en una piscina entre dos equipo, que consiste en introducir el balón en la portería contraria." }
            ],
            [
                {letter: "x", answer: "BOTOX", question: "CONTIENE LA X. Toxina bacteriana utilizada en cirujía estética."},
                {letter: "x", answer: "XILOFONO", question: "CONT LA X. Instrumento musical formado por láminas de diferentes tamaños, que suenan al golpearlas." }
            ],
            [
    ...
    for(let i=0; i<randomQuestions.length; i++){
        userAnswer = prompt(randomQuestions[i].question).toUpperCase()
            switch(userAnswer){
                ...
                case "END":
                    i=27
                    console.log(`Juego terminado, has acertado un total de ${points} preguntas`)
                    break;
                ...
                default:
                    answered++
                    points+=0
                    console.log(`Incorrecto! La respuesta correcta era ${(randomQuestions[i].answer).toLowerCase()}`)
                    break;
            }
    }
